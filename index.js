...
const totalUnfunded = GAMES_JSON.filter((games)=>{
    return games.pledged < games.goal;
}).length;

// create a string that explains the number of unfunded games using the ternary operator

const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames - totalUnfunded} games.Currently, ${totalUnfunded} game${totalUnfunded > 1 ? "s" : ""} remains unfunded. We need your help to fund these amazing games!`;
